...
public class MainJFrameNew extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        controlJPanel.setBackground(new java.awt.Color(153, 0, 0));
        ...
        controlJPanel.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 60, 80, 20));
        ...
        controlJPanel.add(userNameTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 60, 130, -1));

        jLabel3.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Password");
        controlJPanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 100, 70, 20));
        ...
        controlJPanel.add(passwordField, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 100, 130, 20));

        signInJButton.setBackground(new java.awt.Color(236, 255, 234));
        ...
        controlJPanel.add(signInJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 130, 79, 20));
        ...
        controlJPanel.add(customerJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 130, 110, 19));

        signOutJButton.setBackground(new java.awt.Color(236, 255, 234));
        ...
        controlJPanel.add(signOutJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 160, 110, -1));

        jLabel9.setFont(new java.awt.Font("Palatino Linotype", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Admin/Customer Login");
        controlJPanel.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 10, -1, 20));

        jLabel5.setFont(new java.awt.Font("Palatino Linotype", 1, 36)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Welcome to the Car World");
        controlJPanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 500, 60));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/user final.png"))); // NOI18N
        jLabel1.setText("jLabel1");
        controlJPanel.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 50, 40, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/lock.png"))); // NOI18N
        jLabel6.setText("jLabel6");
        controlJPanel.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 90, 30, -1));
        ...
        frontLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/redcar1.jpg"))); // NOI18N
        frontLabel.setText("ghjghj");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jSplitPane1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 1804, Short.MAX_VALUE)
        );
